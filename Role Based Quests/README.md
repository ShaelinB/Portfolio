...
To evaluate the impact of these systems, I conducted a playtest where participants experienced both versions of the quest system. Each participant was also assigned a role to follow, and I observed how frequently quests were accepted in each system. From my finding it did support the claim although based on other factors such as quest balance and role calculation the data may not be significant.
